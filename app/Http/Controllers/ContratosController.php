...
{ 
    ...
    public function listar_plantillas(){
       $titulo = 'Plantillas registradas';
        ...
        return view('plantillas.listado_plantillas',compact('titulo',"vendedoras",'modulo','seccion','centros','dolar','uf','proveedores','clientes','correlativo','factor','session','articulos'));
    } 

   public function registrar_editar_plantilla(Request $request){

    if($request->hasFile("archivo")){
       $file=$request->file("archivo");
       $nombre =$request->nombre .time().".".$file->guessExtension();
       $ruta = public_path("plantillas/".$nombre);
       copy($file, $ruta);
    }
 ...
 // Storage::delete('dQp3QQBzy4DgZjAyd9ylXj4puGe57wbL3EQ00SJC.docx');
   ...
   public function registrar_editar_contrato(){
    ...
    public function listado_contrato_compras(){
    ...
    public function data_listado_contratos_compra(Request $request){
