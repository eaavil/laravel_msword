...
<body translate="no" >
  ...
  <div class="flexy-center">
    <div class="button__container">
      <div class="button" id="connect">Acceder</div>
      <div class="button button--disabled" id="reload">Regresar</div>
    </div>
    ...
    <div class="container__title" id="container__title">No Autorizado</div>
  </div>
        ...
        connect.click(function () {
          ...
          container.one('webkitTtransitionEnd otransitionend msTransitionEnd transitionend', function () {
            ...
            container.one('webkitAnimationEnd oanimationend msAnimationEnd animationend', function () {
                reload.removeClass('button--disabled');
