<div class="modal fade" id="modal-lg" aria-hidden="true" style="display: none;">
   <div class="modal-dialog modal-lg">
      ...
      <div class="modal-body">
         <form action="{{ route('dashboard.clients.add') }}" method="post" class="frm_reg">
         {{ csrf_field() }}
         <div class="row">
            <div class="col-6">
               ...
               <div class="row">
                  ...
                  <div class="col-6">
                     <div class="form-group">
                        ...
                        <span class="btn btn-success testcr">Probar Conexion</span>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <div class="modal-footer justify-content-between">
         <button type="button" class="btn btn-block btn-primary trigger_form" target="frm_reg">Procesar Registro</button>
      </div>
      </div>
      <!-- /.modal-content -->
   </div>
