<div class="modal fade" id="modal-lg" aria-hidden="true" style="display: none;">
   <div class="modal-dialog modal-lg">
      ...
      <div class="modal-body">
         <form action="{{ route('anticipos.registrar') }}" method="post" class="frm_0001">
         {{ csrf_field() }}
         <div class="row">
             <div class="col-12">
         ...
         <div class="row">
            ...
            <div class="col-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control numero_entero valor" name="c04"  aria-describedby="helpId" placeholder="">
                </div>
            </div>
         </div>
         ...
         <div class="row">
            <div class="col-4">
               <div class="form-group">
                  <label>Fecha</label>
                  <input type="date" name="c05" required autocomplete="name-in" class="form-control">
               </div>
            </div>
            <div class="col-4">
               <div class="form-group">
                  <label>N° Cheque / Transaccion</label>
                  <input type="text" name="c06" required maxlength="15" autocomplete="name-in" class="form-control">
               </div>
            </div>
            <div class="col-4">
                <div class="form-group">
