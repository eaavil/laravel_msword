...
<div class="col-12">
    ...
    @include('acceso.usuarios.modals.registro')
    @include('acceso.usuarios.modals.edicion')
@stop
...
<script type="text/javascript" src="https://cdn.datatables.net/v/bs4/jszip-2.5.0/dt-1.10.20/b-1.6.1/b-colvis-1.6.1/b-html5-1.6.1/b-print-1.6.1/cr-1.5.2/fc-3.3.0/fh-3.1.6/kt-2.5.1/r-2.2.3/rg-1.1.1/rr-1.2.6/sc-2.0.1/sp-1.0.1/sl-1.3.1/datatables.min.js"></script>
    ...
    <script>
        ...
        $(document).on('click','.edit',function(){
            ...
            $.get('{{ asset("admin/users/get") }}/'+id,function(d){
                ...
                $(".persona_edit").val(d.id_persona).trigger('change');
                $(".rol").val(d.id_rol).trigger('change');
    ...
    $(document).on('change','.persona',function(){
        ...
        let arr = $(".persona option:selected").text().split(' ');
      alert($(".persona option:selected").val());
       $(".login").val(arr[0].charAt(0)+arr[1]);
       $(".nombres").val( $(".persona option:selected").text());
    });
    
   $(document).on('change','.persona_edit',function(){
        
       let arre = $(".persona_edit option:selected").text().split(' ');
        
        $(".login_edit").val(arre[0].charAt(0)+arre[1]);
        $(".nombres_edit").val( $(".persona_edit option:selected").text());
    });
