<div class="modal fade" id="modal-lgr" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-xs">
       ...
       <div class="modal-body">
          <form action="{{ route('liquidaciones.entradas.reporte') }}"  target="_blank" method="post" class="frmr_0001">
          {{ csrf_field() }}
             <div class="row">
                 <div class="col-6">
				   ...
				   <div class="form-group">
					  ...
					  <label>Reporte:</label>
                         <select class="form-control combo" required name="tipo_reporte"  style="width: 100%;">
                                    <option value="1">Entradas de Cafe para Liquidar</option>
                                    <option value="2">Entradas de Cafe liquidadas</option>
                                    <option value="3">Contratos de Compra sin Liquidar</option>
						</select><br>
                  <div class="col-3">
				   <div class="form-group">
