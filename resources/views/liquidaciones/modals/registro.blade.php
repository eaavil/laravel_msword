			    ...
			    <div  class="contrato2 col-3">
				 ...
				 <div class="filacont">
					<div class="form-group">
					  ...
					  <input type="text" required class="numero_entero form-control c01 xx" name="c01"/>
					</div>
				 </div>
				 <div class="arroba_pasilla col-4">
					<div class="form-group">
					  <label for="">Valor del punto</label>
					  <input type="text"  class="numero_entero form-control v01 xx" name="v01"/>
					</div>
				 </div>
				 <div class="arroba_pasilla col-4">
					<div class="form-group">
					  <label for="">Valor producido</label>
					  <input type="text"  class="form-control v02 xx" name="v02"/>
					</div>
				 </div>
				 <div class="descuentos filacont">
					<div class="form-group">
					  <label for="">Factor Base</label>
					  <input type="text" readonly class="form-control c02 x" value="94" name="c02"/>
					</div>
				 </div>
				 <div class="descuentos filacontkilos">
					<div class="form-group">
					  <label for="">Factor Descuento</label>
					  <input type="text" class=" form-control c03 xx" name="c03"/>
					</div>
				 </div>
				 <div class="descuentos filacont">
					<div class="form-group">
