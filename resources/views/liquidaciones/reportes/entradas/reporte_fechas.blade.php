...
<table width="100%">
          ...
          <h3>Reporte de Liquidaciones de Entradas</h3>
...
@else
<h3 align="center">Reporte de Liquidaciones de Entradas</h3>
...
@if($operaciones!=null)
    <h3 align="center">Contratos Pendientes:</h3><br>
    <table  class="paleBlueRows" style="font-size:80%;margin: 0 auto; " width="100%" border=1 align="center">
	    <thead>
