            ...
            @foreach($rows['proveedor']['data'] as $index => $rowsx)
                <tr>
                    ...
                    @endif
                        ...
                        <td>-{{ number_format($rowsx->descuento_factor,0,',','.') }}</th>
                        ...
                        <td>{{ number_format($rowsx->valor_bruta-($rowsx->valor_descuento+$rowsx->valor_retencion_fuente),0,',','.') }}</th>
                        <td>{{ number_format($rowsx->valor_retencion_4_mil,0,',','.') }}</th>
                        <td>Valor Liquidacion</th>
                        <td>0</th>
                        <td>-{{ number_format($rowsx->valor_bruta-($rowsx->valor_descuento+$rowsx->valor_retencion_fuente+$rowsx->valor_retencion_4_mil),0,',','.') }}</th>
                        <td>-{{ number_format($rowsx->valor_bruta-($rowsx->valor_descuento+$rowsx->valor_retencion_fuente+$rowsx->valor_retencion_4_mil),0,',','.') }}</th>
                ...
                @php
                    try{
                        ...
                        $tot_d+=$rowsx->valor_bruta;
                        $tot_e+=$rowsx->valor_descuento;
                        $tot_f+=$rowsx->valor_retencion_fuente;
                        $tot_g+=$rowsx->valor_bruta-($rowsx->valor_descuento+$rowsx->valor_retencion_fuente);
                        $tot_h+=$rowsx->valor_retencion_4_mil;
                        $tot_j+=$rowsx->valor_bruta-($rowsx->valor_descuento+$rowsx->valor_retencion_fuente+$rowsx->valor_retencion_4_mil);
                        $tot_i-=$rowsx->valor_bruta-($rowsx->valor_descuento+$rowsx->valor_retencion_fuente+$rowsx->valor_retencion_4_mil);
                    }catch(\Exception $e){
                        $tot_i+=$rowsx->valor;
                        $tot_k+=$rowsx->valor;
                    }
