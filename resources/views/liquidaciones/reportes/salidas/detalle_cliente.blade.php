...
<table width="100%">
            ...
            <h2>SALIDAS POR KILOS EN BOGA DEL CLIENTE {{$cliente}}</h2>
            </td><td><td ></td></td>
            <td align="right">
            <p >
	...
	<tbody>
        ...
        @endforeach
          <tr style="background:#ccc; color:black">
            ...
            <td>{{ number_format($Kilos_netos,0,',','.') }}</td>
            <td>{{ number_format($Kilos_bodega,0,',','.') }}</td>
          </tr>
	</tbody>

</table><br>
<button class=" my-3 btn btn-primary boton oculto" onClick="javascript: window.history.go(-1);">Volver</button>
