<table width="746" border="1" cellspacing="0" cellpadding="0">
          ...
          <div align="LEFT" class="Estilo14">
            <table width="951" height="23" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td><div align="center"><strong>ENTRADA DE PRODUCTOS</strong></div></td>
    ...
    <td bgcolor="#D6D6E9"><div align="center" class="Estilo149">{{ $registro[0]->cafe->tipo_cafe }}</div></td>
       <td bgcolor="#D6D6E9"><div align="right" class="Estilo149">{{ number_format( $registro[0]->peso_neto,0,',','.')  }} </div></td>
    ...
    <tr>
      <td height="27" colspan="4"><span class="Estilo140">Proveedor: </span><span class="Estilo125"><span class="Estilo25">{{ $registro[0]->cliente->nombre }}</span></span></td>
    </tr>
    <tr>
