<div class="modal fade" id="modal-lgrl" aria-hidden="true" style="display: none;">
   <div class="modal-dialog modal-xs">
      <div class="modal-content">
      <div class="modal-header">
         <h4 class="modal-title">Generar Reporte de Entrada liquidadas</h4>
         <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
         </button>
      </div>
      <div class="modal-body">
         <form action="{{ route('cafe.entradas.reporte_liquidadas') }}"  target="_blank" method="post" class="frm_0001">
         {{ csrf_field() }}
			<div class="row">
				<div class="col-6">
				...
				<div class="col-12">
				   ...
				   <label>Seleccione reporte</label>
                                <select class="form-control combo" required name="c04" id="c11" style="width: 100%;">
                                    <option value="1">Entradas Liquidadas</option>
                                    <option value="2" selected="true">Entradas sin liquidar</option>
                                </select>
				   </div>
				</div>       				
            </div>
