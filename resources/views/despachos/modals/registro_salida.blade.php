         ...
         <div class="row">
            <div class="col-3">
                <div class="form-group">
                    ...
                    <select required class="form-control combo contrato" name="contrato">
             ...
             <div class="col-3">
                <div class="form-group">
                  ...
                  <input type="text"  required class="form-control c01 x" name="c01"/>
                </div>
             </div>
             <div class="col-2">
                <div class="form-group">
            ...
            <div class="col-3">
             ...
             <div class="col-3">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control c05 x" name="c05"/>
                </div>
             </div>
             <div class="col-3">
                 <div class="form-group">
                   <label for="">Cafe Bruto</label>
                   <input type="text" class="form-control c06" readonly name="c06"/>
                 </div>
             </div>
             <div class="col-3">
                <div class="form-group">
                  <label for="">Valor Descuento</label>
                  <input type="text" class="form-control c07" readonly name="c07"/>
                </div>
             </div>
         </div>
         <h5>Retenciones</h5>
        <div class="row">
            <div class="col-3">
                <div class="form-group">
                  ...
                  <input type="number" value="0.0" min="0" max="100" step="0.01" class="form-control c08 x" name="c08"/>
                </div>
            </div>
            <div class="col-3">
                <div class="form-group">
                  <label for="">Total Retencion Fuente</label>
                  <input type="text" class="form-control c09" readonly name="c09"/>
                </div>
            </div>
            <div class="col-3">
                <div class="form-group">
                  <label for="">Retencion 4 x 1000</label>
                  <input type="number" value="0.0" min="0" max="100" step="0.01" class="form-control c10 x" name="c10"/>
                </div>
            </div>
            <div class="col-3">
                <div class="form-group">
                  <label for="">Total Retencion 4 x 1000</label>
                  <input type="text" class="form-control c11" readonly name="c11"/>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-3">
                <div class="form-group">
                  ...
                  <input type="number" value="0.0" min="0" max="100" step="0.01" class="form-control c12 x" name="c12"/>
                </div>
            </div>
            <div class="col-3">
                <div class="form-group">
                  <label for="">Total Retencion Cooperativa</label>
                  <input type="text" class="form-control c13" readonly name="c13"/>
                </div>
            </div>
            <div class="col-3">
                <div class="form-group">
                  <label for="">Retencion Aporte a Tercero</label>
                  <input type="number" value="0.0" min="0" max="100" step="0.01" class="form-control c14 x" name="c14"/>
                </div>
            </div>
            <div class="col-3">
                <div class="form-group">
                  <label for="">Total Retencion Aporte a Tercero</label>
                  <input type="text" class="form-control c15 x" readonly name="c15" />
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                ...
                <input type="text" class="form-control c16" value="0" readonly name="c16">
                </div>
            </div>
        </div>
