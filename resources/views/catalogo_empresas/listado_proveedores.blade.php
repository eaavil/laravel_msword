...
<div class="col-12">
    ...
    @if(\App\Http\Controllers\AuthController::checkAccessModule('catalogo.registrar.proveedores',session('role_id')))
        @include('catalogo_empresas.000_catalogo_empresas.modals.registro')
    @endif
    @if(\App\Http\Controllers\AuthController::checkAccessModule('catalogo.actualizar.proveedores',session('role_id')))
