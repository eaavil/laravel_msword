           ...
           <!-- creamos el canvas -->
           <i class="fas borrar" role="button" style='font-size:30px;color:black'>FIRME AQUI</i>
           <canvas id='canvas' width='320%' height='280'  top='100'  left='100' style='border: 1px solid #CCC;'></canvas>
            <i  role="button" onclick="limpiar_firma()">Limpiar firma</i>
            ...
            <script type='text/javascript'>
               ...
               pizarraCanvas.width=canvas.width;
               IniciarDibujo();
           }
