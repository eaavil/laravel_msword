...
@section('contenedor_principal')
   ...
   <select class="custom-select lisa_1" name="lista_1">
   ...
   <select class="custom-select Lista_2" name="Lista_2">
     ...
     <select class="custom-select Lista_3" name="Lista_3">
      ...
      <select class="custom-select forma_pago Lista_4" name="Lista_4">
