...
@if(\App\Http\Controllers\AuthController::checkAccessModule('contratos.compra.registrar',session('role_id')))
        @include('contratos.003_contratos.modals.registro_compra')
    @endif
    @if(\App\Http\Controllers\AuthController::checkAccessModule('contratos.compras.actualizar',session('role_id')))
    @include('contratos.003_contratos.modals.edicion_compra')
    @endif
...
<div class="col-12">
    <div class="card">
            ...
            <div class="card-body">
                ...
                <button class="btn btn-info nuevo" style="float:right" data-toggle="modal" data-target="#modal-lg"><i class="fa fa-plus"></i>Salida de caja</button>
...
<script>
        ...
        $(document).on('click','.nuevo',function(){
            ...
            $(".modal-title").text("Registrar Articulos de compra");
            cont=0;
        ...
        $(document).on('click','.edit',function(){ 
            ...
            cont=1;
            $(".origen tbody").html("");
            $(".modal-title").text("Editar cotizacion de compra");
        ...
        var tabla = $('#main').DataTable({
            ...
            columns: [
                ...
                {
                    data: "fecha_contrato",name:'fecha_contrato',
                    render: function (data) {
                        return data.substring(8,10)+'/'+data.substring(5,7)+'/'+data.substring(0,4);
                    }
                },
                {
                    data: null,name:'contrato',
                    render: function (data) {
                        var html;
                        if(data.contrato!=null){
                            html= data.contrato;
                        }
                        else{html= 'STOCK BODEGA';}
                        return html;
                    }
                    
                },
                {
                    data: null,name:'proveedor',
                    render: function (data) {
                        var html;
                ...
                },
                {
                    ...
                    "render": function (data) {
                            ...
                            return html+'<button style="width: 26px; height:26px; padding:0px"  data-id="'+data.id+'" class="btn btn-success print"><i class="fa fa-print"></i></button> \
                                <button style="width: 26px; height:26px; padding:0px" data-target="#modal-lge" data-toggle="modal" data-id="'+data.id+'" data-id_contrato="'+data.id_contrato+'" data-numero="'+data.numero+'" data-cotizacion="'+data.cotizacion+'" data-factura="'+data.factura+'" data-proveedor="'+data.id_catalogo_empresa_proveedor+'" class="btn btn-info edit"><i class="fa fa-pencil-alt"></i></button> \
