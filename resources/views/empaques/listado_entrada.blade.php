...
<div class="col-12">
    <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-3"><br>
                                <button class="btn btn-info " data-toggle="modal" data-target="#modal-lginv"><i class="fa fa-plus"></i>Actualizar totales bodega</button>
                                <button  class="btn btn-secondary" data-toggle="modal" data-target="#modal-lgrs"><i class="fas fa-file"></i> Reportes</button><br>
                    </div>
                    <div  class="col-7"><br>
                        <button class="btn btn-info float-right"  data-toggle="modal" data-target="#modal-lg"><i class="fa fa-plus"></i> Nueva Salida</button>
    ...
    @include('empaques.modals.reporte_proveedores')
    @include('empaques.modals.registro_entrada')
    @include('empaques.modals.edicion_entrada')
@stop
...
<script type="text/javascript" src="https://cdn.datatables.net/v/bs4/jszip-2.5.0/dt-1.10.20/b-1.6.1/b-colvis-1.6.1/b-html5-1.6.1/b-print-1.6.1/cr-1.5.2/fc-3.3.0/fh-3.1.6/kt-2.5.1/r-2.2.3/rg-1.1.1/rr-1.2.6/sc-2.0.1/sp-1.0.1/sl-1.3.1/datatables.min.js"></script>
    ...
    <script>
        ...
        $(document).on('click','.delete',function(){
            ...
            if(@json($session)==1){
                if(confirm('Estas Seguro de Eliminar el Registro Seleccionado?')&&@json($session)==1){
                    window.location='{{ asset("empaques/eliminar") }}/'+id;
                }
            }else{
        ...
        $('.prov').change(function(){
            ...
            $.get('{{ asset("empaques/entrada/general") }}/'+id,function(d){
